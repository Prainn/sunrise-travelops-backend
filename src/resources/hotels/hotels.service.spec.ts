...
describe('HotelsService', () => {
  it('applies keyword, city and rating filters before pagination', () =>
    withResourceScope(
  ...
  it('does not partially soft-delete when any requested id is missing', () =>
    withResourceScope(
      { resourceLibrary: 'shengxu' } as AuthenticatedUser,
      null,
      async () => {
  ...
  it('soft-deletes every requested resource in one transaction', () =>
    withResourceScope(
      { resourceLibrary: 'shengxu' } as AuthenticatedUser,
      null,
      async () => {
